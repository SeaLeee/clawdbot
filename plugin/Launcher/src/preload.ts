...
contextBridge.exposeInMainWorld("api", {
  ...
  oneClickOpenOpenClaw: () => ipcRenderer.invoke("one-click-open-openclaw"),
  oneClickOpenCrabwalk: () => ipcRenderer.invoke("one-click-open-crabwalk"),
  oneClickOpenAll: () => ipcRenderer.invoke("one-click-open-all"),
  oneClickOpenSkillDashboard: () => ipcRenderer.invoke("one-click-open-skill-dashboard"),
  ...
  onOneClickProgress: (callback: (event: any, data: any) => void) => {
    ipcRenderer.on("one-click-progress", callback);
    return () => ipcRenderer.removeListener("one-click-progress", callback);
  },
});
